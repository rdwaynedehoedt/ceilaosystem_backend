...
async function migrateClientsTable() {
  try {
    console.log('Starting migration to add new fields to clients table...');
    ...
    for (const field of newFields) {
      try {
        ...
        console.log(`⚠ Field ${field.split(' ')[0]} might already exist or error occurred:`, error);
      }
    }
    ...
    for (const indexName of indexes) {
      try {
        ...
        console.log(`⚠ Index ${indexName} might already exist or error occurred:`, error);
      }
    }
